...
class HopAlertsFetchPlugin extends BasePlugin
{
	...
	protected function defineSettings()
	{
		return array(
			...
			'field_name_alert_type'             => array(AttributeType::String, 'label' => 'Field Handle for Alert Type', 'default' => ''),
			'field_name_alert_ext_id'           => array(AttributeType::String, 'label' => 'Field Handle for External ID', 'default' => ''),
			'field_name_alert_body'             => array(AttributeType::String, 'label' => 'Field Handle for Body', 'default' => ''),
